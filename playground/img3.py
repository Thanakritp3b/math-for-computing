...
image = io.imread("./playground/hearts.jpeg")  # Replace with your image filename
...
for i, contour in enumerate(contours):
    ...
    # Import CSV
    coeffs_x = genfromtxt('./playground/vday_plot_8_x_coeffs.csv', delimiter=',')
    coeffs_y = genfromtxt('./playground/vday_plot_8_y_coeffs.csv', delimiter=',')
